                                    ...
                                    <table id="listcustomer" class="table table-striped table-bordered table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td ><button type="button" class="btn btn-warning passingID" data-toggle="modal" data-id="{{ $customer->id }}" data-target="#ajax-customers-modal">Edit</button>
                                                <button type="button" class="btn btn-primary detailID" data-id="{{ $customer->id }}">Detail</button></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
